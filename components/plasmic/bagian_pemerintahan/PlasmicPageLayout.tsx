...
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: soRtl0ZLW8i/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: 8toS3Wjp6rS/icon
import Logobagpembatang300SvgIcon from "./icons/PlasmicIcon__Logobagpembatang300Svg"; // plasmic-import: MDSlYUkr1v/icon
...
function PlasmicPageLayout__RenderFunc(props: {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Logobagpembatang300SvgIcon
          className={classNames(projectcss.all, sty.svg__cbyVt)}
          role={"img"}
        />
      }
      menu={(() => {
      ...
      navMenuItems={(() => {
        ...
        __composite["0"]["path"] = `/`;
        __composite["0"]["name"] = "Beranda";
        __composite["1"]["path"] = `/hutri`;
        __composite["1"]["name"] = "HUT RI";
        return __composite;
      })()}
      simpleNavTheme={(() => {
        const __composite = { scheme: null, customBgColor: null };
        __composite["scheme"] = "custom";
        __composite["customBgColor"] = "var(--token--ypw6enySR1T)";
        return __composite;
      })()}
      title={"Bagian Pemerintahan" as const}
    >
      <LoadingBoundary
        ...
        loadingState={
          <ph.DataCtxReader>
            {$ctx =>
              true ? (
                <div className={classNames(projectcss.all, sty.freeBox__tezAs)}>
                  <IconIcon
                    className={classNames(projectcss.all, sty.svg__bgx5A)}
                    role={"img"}
                  />
                </div>
              ) : null
      ...
      >
        <ph.DataCtxReader>
          {$ctx =>
            true ? (
              <div className={classNames(projectcss.all, sty.freeBox__qwt1M)}>
                {p.renderPlasmicSlot({
                  defaultContents: (
                    <section
                      className={classNames(
                    ...
                    >
                      ...
                      >
                        {"Portal Bagian Pemerintahan SETDA Batang"}
                      </div>
                    </section>
                  ),
                  value: args.children
