...
import sty from "./PlasmicHomepage.module.css"; // plasmic-import: sl3qNfh4XI/css
  ...
  return (
    <React.Fragment>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        <div
          data-plasmic-name={"bagpemHome"}
          data-plasmic-override={overrides.bagpemHome}
...
const PlasmicDescendants = {
  bagpemHome: ["bagpemHome", "pageLayout", "section", "h1", "text"],
...
export const PlasmicHomepage = Object.assign(
  ...
  withUsePlasmicAuth(withPlasmicPageGuard(makeNodeComponent("bagpemHome"))),
  {
    ...
    // Page metadata
    pageMetadata: {
      title: "Bagian Pemerintahan SETDA Kab. Batang",
      description: "Portal Bagian Pemerintahan SETDA Kab. Batang",
      ogImageSrc:
        "https://site-assets.plasmic.app/1cadb600af285b90587e1c8e45dd0ff1.jpg",
      canonical: "https://www.bagpem.my.id"
    }
  }
);
